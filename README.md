...
* [Source Code](https://github.com/beancount/beancount) ⭐ 5,982 | 🐛 237 | 🌐 Python | 📅 2026-08-23
...
* [rustledger](https://github.com/rustledger/rustledger) ⭐ 383 | 🐛 10 | 🌐 Rust | 📅 2026-09-08 - Pure Rust implementation, drop-in replacement, 10x faster
...
* [WeChat Pay / 微信支付](https://github.com/deb-sig/double-entry-generator) ⭐ 717 | 🐛 27 | 🌐 Go | 📅 2026-08-04
...
* Alipay / 支付宝
  * [deb-sig/double-entry-generator](https://github.com/deb-sig/double-entry-generator) ⭐ 717 | 🐛 27 | 🌐 Go | 📅 2026-08-04
...
* [Deutsche Kredit Bank](https://github.com/siddhantgoel/beancount-dkb) ⭐ 52 | 🐛 0 | 🌐 Python | 📅 2026-09-08
* [ING](https://github.com/siddhantgoel/beancount-ing) ⭐ 36 | 🐛 1 | 🌐 Python | 📅 2026-09-07
* [N26](https://github.com/siddhantgoel/beancount-n26) ⭐ 28 | 🐛 1 | 🌐 Python | 📅 2026-09-07
...
* [SBI/BOI/PAYTM/HSBC/ICICI](https://github.com/dumbPy/beancount-importers-india) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2024-10-19
...
* [Monzo](https://github.com/Evernight/beancount-importers/) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2025-03-12
* Revolut
  * [Evernight/beancount-importers](https://github.com/Evernight/beancount-importers/blob/main/src/beancount_importers/import_revolut.py) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2025-03-12
  * [tariochbctools](https://tariochbctools.readthedocs.io/en/latest/importers.html#revolut)
* Wise:
  * [Evernight/beancount-importers](https://github.com/Evernight/beancount-importers/blob/main/src/beancount_importers/import_wise.py) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2025-03-12
...
* [open-banking.io](https://github.com/open-banking-io/clients/tree/main/beancount) ⭐ 14 | 🐛 12 | 🌐 Go | 📅 2026-09-07: beangulp importer syncing EEA & UK bank transactions over PSD2, decrypted client-side; no eIDAS certificate and no per-account daily rate-limit (`pip install beancount-openbanking-io`)
...
* JSON
  * <https://github.com/LaunchPlatform/beancount-exporter> ⭐ 5 | 🐛 2 | 🌐 Python | 📅 2026-08-11
...
* [ctags](https://github.com/aldur/dotfiles/blob/master/various/ctags/beancount.ctags) ⭐ 23 | 🐛 0 | 🌐 Nix | 📅 2026-09-08
...
* [beancount-lazy-plugins.filter\_map](https://github.com/Evernight/beancount-lazy-plugins/blob/main/docs/filter_map/README.md) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-06-01 - apply operations to group of transactions selected by Fava filters
* [beancount-lazy-plugins.valuation](https://github.com/Evernight/beancount-lazy-plugins/blob/main/docs/valuation/README.md) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-06-01 - track total value of the opaque fund over time
* [beancount-lazy-plugins.tag\_from\_continuous\_events](https://github.com/Evernight/beancount-lazy-plugins/blob/main/docs/tag_from_continuous_events/README.md) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-06-01 - apply tags to transactions based on Events
* [beancount-lazy-plugins.balance\_extended](https://github.com/Evernight/beancount-lazy-plugins/blob/main/docs/balance_extended/README.md) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-06-01 - adds extended balance assertions (full, padded, full-padded)
...
* [double-entry-generator](https://github.com/deb-sig/double-entry-generator) ⭐ 717 | 🐛 27 | 🌐 Go | 📅 2026-08-04 - Rule-based double-entry bookkeeping importer (from Alipay/WeChat/Huobi to Beancount).
...
* [Slashbooks](https://github.com/giltotherescue/slashbooks) ⭐ 33 | 🐛 0 | 🌐 Python | 📅 2026-08-24 - Local-first bookkeeping agent that can export Beancount for inspection in PTA tools
* [Beancount Bot](https://github.com/StdioA/beancount-bot) ⭐ 30 | 🐛 0 | 🌐 Python | 📅 2026-05-19 - Telegram / Mattermost bot to generate new transactions with few words
* [CSV to Beancount](https://github.com/PaNaVTEC/csv2beancount) ⭐ 22 | 🐛 0 | 🌐 Clojure | 📅 2017-02-24
...
* [beanhub-web-react](https://github.com/LaunchPlatform/beanhub-web-react) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-19 - React components for beancount entry input forms and [beanhub-forms](https://github.com/LaunchPlatform/beanhub-forms) ⭐ 16 | 🐛 5 | 🌐 Python | 📅 2026-03-06
...
* [xuhcc/beancount-exchangerates](https://github.com/xuhcc/beancount-exchangerates) ⭐ 15 | 🐛 1 | 🌐 Python | 📅 2024-12-27 for [frankfurter.dev](https://frankfurter.dev/) or [exchangeratesapi.io](https://exchangeratesapi.io/) or other [fixer.io](https://fixer.io/)-like 💱 APIs
...
* [Lazy Beancount: Beancount and tools in Docker with an alternative use guide](https://github.com/Evernight/lazy-beancount) ⭐ 170 | 🐛 5 | 🌐 TypeScript | 📅 2026-06-03
