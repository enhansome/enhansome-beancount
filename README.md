...
* [Source Code](https://github.com/beancount/beancount) ⭐ 5,904 | 🐛 235 | 🌐 Python | 📅 2026-05-18
...
* [rustledger](https://github.com/rustledger/rustledger) ⭐ 360 | 🐛 7 | 🌐 Rust | 📅 2026-08-15 - Pure Rust implementation, drop-in replacement, 10x faster
...
* [WeChat Pay / 微信支付](https://github.com/deb-sig/double-entry-generator) ⭐ 712 | 🐛 27 | 🌐 Go | 📅 2026-08-04
...
* Alipay / 支付宝
  * [deb-sig/double-entry-generator](https://github.com/deb-sig/double-entry-generator) ⭐ 712 | 🐛 27 | 🌐 Go | 📅 2026-08-04
...
* [Deutsche Kredit Bank](https://github.com/siddhantgoel/beancount-dkb) ⭐ 52 | 🐛 1 | 🌐 Python | 📅 2026-08-10
* [ING](https://github.com/siddhantgoel/beancount-ing) ⭐ 36 | 🐛 1 | 🌐 Python | 📅 2026-08-03
* [N26](https://github.com/siddhantgoel/beancount-n26) ⭐ 29 | 🐛 1 | 🌐 Python | 📅 2026-08-03
...
* [Boursorama, Amex, ... ](https://github.com/grostim/Beancount-myTools) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2026-06-08
* [Caisse d'Epargne](https://github.com/ArthurFDLR/beancount-ce) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2024-01-04
* [Fortuneo, Crédit Mutuel](https://github.com/vrischmann/beancount-importers) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2025-11-23

### India

* [SBI/BOI/PAYTM/HSBC/ICICI](https://github.com/dumbPy/beancount-importers-india) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2024-10-19

### The Netherlands

* [ABN AMRO Bank](https://github.com/deepakg/beancount-abnamro) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2024-01-21

### Switzerland

* [Finpension](https://github.com/Dr-Nuke/drnuke-bean?tab=readme-ov-file#finpension-importer) ⭐ 19 | 🐛 3 | 🌐 Python | 📅 2026-08-10
...
* [Monzo](https://github.com/Evernight/beancount-importers/) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2025-03-12
* Revolut
  * [Evernight/beancount-importers](https://github.com/Evernight/beancount-importers/blob/main/src/beancount_importers/import_revolut.py) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2025-03-12
  * [tariochbctools](https://tariochbctools.readthedocs.io/en/latest/importers.html#revolut)
* Wise:
  * [Evernight/beancount-importers](https://github.com/Evernight/beancount-importers/blob/main/src/beancount_importers/import_wise.py) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2025-03-12
  * [tariochbctools](https://tariochbctools.readthedocs.io/en/latest/importers.html#wise-formerly-transferwise)

### US

* [Amazon](https://github.com/redstreet/beancount_reds_importers/tree/main/beancount_reds_importers/importers/amazon) ⭐ 165 | 🐛 32 | 🌐 Python | 📅 2026-04-30 (GDPR Download order data, gift card. pip-installable)
* [IBKR](https://github.com/redstreet/beancount_reds_importers/tree/main/beancount_reds_importers/importers/ibkr) ⭐ 165 | 🐛 32 | 🌐 Python | 📅 2026-04-30 (Flex Query importer and downloader)
* [Red's Importers](https://github.com/redstreet/beancount_reds_importers/tree/main/beancount_reds_importers/importers) ⭐ 165 | 🐛 32 | 🌐 Python | 📅 2026-04-30 (Including Ally, Chase, Citi, Fidelity, Schwab, Vanguard, pip-installable)
...
* [Capital One](https://github.com/mtlynch/beancount-capitalone) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-03-23 (Credit, pip-installable)
...
* [open-banking.io](https://github.com/open-banking-io/clients/tree/main/beancount) ⭐ 9 | 🐛 4 | 🌐 Go | 📅 2026-08-15: beangulp importer syncing EEA & UK bank transactions over PSD2, decrypted client-side; no eIDAS certificate and no per-account daily rate-limit (`pip install beancount-openbanking-io`)
...
* [Tree-Sitter](https://github.com/polarmutex/tree-sitter-beancount) ⭐ 54 | 🐛 7 | 🌐 Rust | 📅 2026-07-26
* [Sublime Text](https://github.com/norseghost/sublime-beancount) ⭐ 35 | 🐛 8 | 🌐 Python | 📅 2025-11-06
* [ctags](https://github.com/aldur/dotfiles/blob/master/various/ctags/beancount.ctags) ⭐ 23 | 🐛 1 | 🌐 Nix | 📅 2026-08-15
...
* [autobean.sorted](https://github.com/SEIAROTg/autobean/tree/master/autobean/sorted) ⭐ 77 | 🐛 8 | 🌐 Python | 📅 2026-07-12: Checks that transactions are in non-descending order in each file
* [autobean.truelayer](https://github.com/SEIAROTg/autobean/tree/master/autobean/truelayer) ⭐ 77 | 🐛 8 | 🌐 Python | 📅 2026-07-12: Imports transactions from banks via [TrueLayer](https://truelayer.com/), a bank API aggregator
* [autobean.xcheck](https://github.com/SEIAROTg/autobean/tree/master/autobean/xcheck) ⭐ 77 | 🐛 8 | 🌐 Python | 📅 2026-07-12: Cross-checks against external ledgers
* [portfolio-returns](https://github.com/hoostus/portfolio-returns) ⭐ 42 | 🐛 1 | 🌐 Python | 📅 2022-08-28 calculates money-weighted and time-weighted returns for a portfolio
* [portfolio\_allocation](https://github.com/ghislainbourgeois/beancount_portfolio_allocation) ⭐ 31 | 🐛 0 | 🌐 Python | 📅 2025-11-29 reports on portfolio asset allocations; useful for risk analysis and for rebalancing purposes.
* [beancount-balancechange](https://github.com/daniel-wells/beancount_balancechange) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2025-07-12 - Checks *change* in balance between two dates
* [beancount-balexpr](https://github.com/w1ndy/beancount_balexpr) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2025-09-24 - Check balances against simple expressions combining accounts in Beancount
* [beancount-checkclosed](https://github.com/daniel-wells/beancount_checkclosed) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2025-07-12 - Automatically insert a 0 balance check for closed balance sheet accounts
* [beancount-lazy-plugins.filter\_map](https://github.com/Evernight/beancount-lazy-plugins/blob/main/docs/filter_map/README.md) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2026-06-01 - apply operations to group of transactions selected by Fava filters
* [beancount-lazy-plugins.valuation](https://github.com/Evernight/beancount-lazy-plugins/blob/main/docs/valuation/README.md) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2026-06-01 - track total value of the opaque fund over time
* [beancount-lazy-plugins.tag\_from\_continuous\_events](https://github.com/Evernight/beancount-lazy-plugins/blob/main/docs/tag_from_continuous_events/README.md) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2026-06-01 - apply tags to transactions based on Events
* [beancount-lazy-plugins.balance\_extended](https://github.com/Evernight/beancount-lazy-plugins/blob/main/docs/balance_extended/README.md) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2026-06-01 - adds extended balance assertions (full, padded, full-padded)
...
* [fava-dashboards](https://github.com/andreasgerstmayr/fava-dashboards) ⭐ 398 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-15 - Additional fully custom dashboards
...
* [fava\_budget\_freedom](https://github.com/Leon2xiaowu/fava_budget_freedom) ⭐ 12 | 🐛 1 | 🌐 Python | 📅 2026-02-07 provide flexible and powerful budget management and visualization features
...
* [fava-git](https://github.com/Evernight/fava-git) ⭐ 5 | 🐛 2 | 🌐 TypeScript | 📅 2026-04-09 - simple Git integration for Fava

## Tools

* [double-entry-generator](https://github.com/deb-sig/double-entry-generator) ⭐ 712 | 🐛 27 | 🌐 Go | 📅 2026-08-04 - Rule-based double-entry bookkeeping importer (from Alipay/WeChat/Huobi to Beancount).
...
* [Moneywiz3 to Beancount](https://github.com/zhangzhishan/beancount_importer) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2020-07-07
* [beanhub-web-react](https://github.com/LaunchPlatform/beanhub-web-react) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-10 - React components for beancount entry input forms and [beanhub-forms](https://github.com/LaunchPlatform/beanhub-forms) ⭐ 16 | 🐛 5 | 🌐 Python | 📅 2026-03-06
* GnuCash to Beancount
  * <https://github.com/henriquebastos/gnucash-to-beancount/> ⭐ 34 | 🐛 12 | 🌐 Python | 📅 2022-09-27
...
* [Cryptoassets](https://github.com/xuhcc/beancount-cryptoassets) ⭐ 19 | 🐛 0 | 🌐 Python | 📅 2026-03-07
* [xuhcc/beancount-exchangerates](https://github.com/xuhcc/beancount-exchangerates) ⭐ 14 | 🐛 1 | 🌐 Python | 📅 2024-12-27 for [frankfurter.dev](https://frankfurter.dev/) or [exchangeratesapi.io](https://exchangeratesapi.io/) or other [fixer.io](https://fixer.io/)-like 💱 APIs
...
* [Lazy Beancount: Beancount and tools in Docker with an alternative use guide](https://github.com/Evernight/lazy-beancount) ⭐ 166 | 🐛 6 | 🌐 TypeScript | 📅 2026-06-03
